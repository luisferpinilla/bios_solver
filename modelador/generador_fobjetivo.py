...
def _costos_almacenamiento_puerto(variables:dict, costos_almacenamiento:dict, cargas:list):
...
def generar_fob(parametros:dict, variables:dict):
    ...
    fob.append(_costos_almacenamiento_puerto(variables, costos_almacenamiento, cargas))
