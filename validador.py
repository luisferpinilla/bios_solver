...
class Validador():
    ...
    def _validar_operadores(self):
        ...
        for operador in self.operadores:
            ...
            if not puerto in self.puertos:
                self.cantidad_errores+=1
                self.validaciones['operadores y puertos'] = "Error, el puerto {puerto} no esta en la lista de puertos"
    ...
    def _validar_demanda(self):
        ...
        ingredientes_no_encontrados = [x for x in ingredientes if not x in self.ingredientes]
        ...
        if len(ingredientes_no_encontrados)>0 :
            self.cantidad_errores+=1
            self.validaciones['demanda de ingredientes'] = f"Error, los ingredientes {ingredientes_no_encontrados} no se encuetran en la lista de ingredientes"
    ...
    def _validar_safety_stock(self):
        ...
        if len(ingredientes_no_encontrados)>0 :
            self.cantidad_errores+=1
            self.validaciones['Safety stock de ingredientes'] = f"Error, los ingredientes {ingredientes_no_encontrados} no se encuetran en la lista de ingredientes"
