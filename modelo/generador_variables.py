...
def _despacho_directo(variables: dict, periodos: list,  cargas: list, plantas: list):
...
def _despacho_desde_puerto(variables: dict, cargas: list, plantas: list, periodos: list):
