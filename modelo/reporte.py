...
class Reporte():
    ...
    def obtener_fact_transporte(self) -> dict:
        ...
        for carga in self.problema.conjuntos['cargas']:
            for planta in self.problema.conjuntos['plantas']:
                for periodo in self.problema.conjuntos['periodos']:
                    df_dict['carga'].append(carga)
